...
from PyQt6.QtGui import QIcon, QFont, QIntValidator, QDesktopServices
...
class MainWindow(QMainWindow):
    ...
    @staticmethod
    def TransformName(name: str, chars: int = 0, from_start: bool = False, from_end: bool = False, remove_spaces: bool = False, exact_str: str = '') -> str:
        if chars > 0:
            if from_start:
                name = name[chars:]
